...
extern class ImageEditorImagick {
  /**
  ...
  **/
  @:native("set_quality") public function setQuality(quality:Int = null):haxe.extern.EitherType<Bool, wp.extern.Error>;
  /**
  ...
  **/
  @:native("save") public function save(destfilename:String = null, mime_type:String = null):haxe.extern.EitherType<php.NativeStructArray<Dynamic>, wp.extern.Error>;
  /**
  ...
  **/
  @:native("stream") public function stream(mime_type:String = null):haxe.extern.EitherType<Bool, wp.extern.Error>;
}
